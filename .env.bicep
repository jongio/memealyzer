...
# TERRAFORM VARS
TF_VAR_basename=${BASENAME}
TF_VAR_location=${REGION}
TF_VAR_failover_location=${FAILOVER_REGION}

# SCRIPT VARS
AZURE_AKS_CLUSTER_NAME=${BASENAME}aks
...
# FOR FUNCTION APP BINDING
AZURE_CLIENT_SYNC_QUEUE_NAME=sync

FUNCTIONS_ENDPOINT=http://${BASENAME}function.azurewebsites.net
#API_ENDPOINT=
